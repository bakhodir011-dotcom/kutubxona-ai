const translations = {
    en: {
        ...
        welcomeMsg2: "I can help you find books for language learning and prepare for exams such as IELTS, SAT, AP, and Cambridge CEQ.",
    ...
    uz: {
        ...
        welcomeMsg2: "Men sizga til o'rganish va IELTS, SAT, AP hamda Cambridge CEQ kabi imtihonlarga tayyorgarlik ko'rish uchun kitoblar topishda yordam bera olaman.",
    ...
    ru: {
        ...
        welcomeMsg2: "Я могу помочь вам найти книги для изучения языков и подготовки к экзаменам, таким как IELTS, SAT, AP и Cambridge CEQ.",
