...
<div class="slide">
    ...
    <header class="header">
        ...
        <div class="header-center">
            <div class="exec-badge">
                ...
                Yagona Strategik Taqdimot Slaydi
            </div>
            <div class="target-badge">
                O'zbekiston Respublikasi Raqamli Texnologiyalar Vazirligi Uchun
            </div>
        </div>
        ...
        <div class="header-right">
            <div class="status-pill">
                ...
                <span>Ishchi Tizim: <a href="https://kutubxona-ai.vercel.app" class="web-link" target="_blank">kutubxona-ai.vercel.app</a></span>
            </div>
        </div>
    </header>
    ...
    <div class="main-grid">
            ...
            <div class="card">
                ...
                <div class="modules-container">
                    ...
                    <div class="module-item">
                        <div class="module-icon">📊</div>
                        <div class="module-info">
                            <div class="module-head">Vazirlik Uchun Admin Monitoring</div>
                            <div class="module-desc">Viloyatlar va tumanlar kesimida o'quvchilarning fanlar bo'yicha qiziqishlari va bilim dinamikasi monitoringi.</div>
                            <div class="module-tags">
                                <span class="m-tag">✓ Hududiy Kesim</span>
                                <span class="m-tag">✓ Real-vaqt Dashboard</span>
                                <span class="m-tag">✓ O'sish Tahlili</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Column 3: Ministry Partnership & Team -->
        <div class="col">
            <div class="card">
                <div>
                    <div class="card-header">
                        <div class="card-badge">3</div>
                        <div class="card-title">Vazirlik Bilan 4 Bosqichli Reja</div>
                        <div class="card-subtitle">Yo'l Xaritasi</div>
                    </div>
                    ...
                    <div class="steps-container">
                        <div class="step-item">
                            ...
                            <div class="step-info">
                                <div class="step-head-row">
                                    <div class="step-head">Akkreditatsiya & Metodik Ekspertiza</div>
                                    <div class="step-timeline">1-bosqich</div>
                                </div>
                                <div class="step-desc">Vazirlik bilan texnik ekspertiza va rasmiy tavsiya olish.</div>
                            </div>
                        </div>
                        ...
                        <div class="step-item">
                            ...
                            <div class="step-info">
                                <div class="step-head-row">
                                    <div class="step-head">Maktab & Kutubxona Integratsiyasi</div>
                                    <div class="step-timeline">2-bosqich</div>
                                </div>
                                <div class="step-desc">"e-Maktab" (Kundalik) va kutubxonalar tarmog'iga yagona kirish orqali ulash.</div>
                            </div>
                        </div>
                        ...
                        <div class="step-item">
                            ...
                            <div class="step-info">
                                <div class="step-head-row">
                                    <div class="step-head">Milliy Darsliklar Bazasini Boyitish</div>
                                    <div class="step-timeline">3-bosqich</div>
                                </div>
                                <div class="step-desc">Davlat darsliklari va test namunalarini AI bilimlar omboriga yuklash.</div>
                            </div>
                        </div>
                        ...
                        <div class="step-item">
                            ...
                            <div class="step-info">
                                <div class="step-head-row">
                                    <div class="step-head">Respublika Miqyosida Qamrov</div>
                                    <div class="step-timeline">4-bosqich</div>
                                </div>
                                <div class="step-desc">14 ta hududdagi markaz va kutubxonalarda 100,000+ yoshlarga ochish.</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div style="font-size: 15px; font-weight: 700; color: #cbd5e1; margin-bottom: 6px; display: flex; justify-content: space-between; align-items: center;">
                        <span style="display: flex; align-items: center; gap: 8px; color: #f1f5f9;">🏛️ Vazirlik Uchun Strategik Integratsiya & Kafolatlar</span>
                        <span style="color: #10b981; font-weight: 700; font-size: 12px; background: rgba(16, 185, 129, 0.12); border: 1px solid rgba(16, 185, 129, 0.35); padding: 2px 8px; border-radius: 4px;">STANDART</span>
                    </div>
                    <div class="guarantee-grid">
                        <div class="g-card">
                            <div class="g-icon">🔗</div>
                            <div class="g-name">e-Maktab & ONE ID</div>
                            <div class="g-desc">Yagona ta'lim tizimiga to'liq integratsiya</div>
                        </div>
                        <div class="g-card">
                            <div class="g-icon">🛡️</div>
                            <div class="g-name">Milliy Suverenitet</div>
                            <div class="g-desc">100% mahalliy xavfsiz serverlar</div>
                        </div>
                        <div class="g-card">
                            <div class="g-icon">📊</div>
                            <div class="g-name">Real-Vaqt Monitoring</div>
                            <div class="g-desc">Hududiy bilim tahlili & monitoring paneli</div>
                        </div>
                        <div class="g-card">
                            <div class="g-icon">💎</div>
                            <div class="g-name">Ijtimoiy Tenglik</div>
                            <div class="g-desc">Barcha hududlarga 100% bepul ta'lim</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer class="footer">
        <div class="footer-left">
            <strong>Kutubxona AI</strong> — O'zbekiston Respublikasi Raqamli Texnologiyalar Vazirligi <strong>"Raqamli O'zbekiston — 2030"</strong> strategiyasi doirasida ishlab chiqilgan milliy tashabbus.
        </div>
        <div class="footer-right">
            <span>📍 Samarqand / Toshkent</span>
            <span>🌐 <a href="https://kutubxona-ai.vercel.app" class="footer-link" target="_blank">kutubxona-ai.vercel.app</a></span>
